...
const replacements = [
  ...
  ['Tecnología humana y cercana para profesionales de salud y bienestar.', 'Tecnología a medida para negocios de servicios. Barcelona.'],
  ['El Mapa de Safari', 'El Diagnóstico 1:1'],
  ['Reservar mi Mapa', 'Reservar mi Diagnóstico'],
  ['La Radiografía de tu negocio', 'El Diagnóstico 1:1'],
  ['Reservar mi Radiografía', 'Reservar mi Diagnóstico'],
  ['precio según la Radiografía', 'precio según el Diagnóstico 1:1'],
  ['Precio según Radiografía', 'Precio según Diagnóstico 1:1'],
  ['radiografía personalizada', 'informe personalizado'],
